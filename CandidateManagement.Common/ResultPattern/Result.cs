...
namespace CandidateManagement.Common.ResultPattern;
...
public class Result<T>(T value, bool isSuccess, Error error) : Result(isSuccess, error)
{
    ...
    [NotNull]
    public T Data => IsSuccess ? value! : throw new InvalidOperationException("The value of a failure result can't be accessed.");
